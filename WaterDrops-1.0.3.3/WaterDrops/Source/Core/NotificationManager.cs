...
{ 
    public class NotificationManager
    {
        ...
        public void Initialize()
        {
            ...
            if (App.Settings.NotificationsEnabled)
            {
                if (App.User.Water.Amount < App.User.Water.Target)
                {
                    ...
                    nextReminderTime = DateTime.Now.AddHours(2);
                    ScheduleDrinkReminderWithText(nextReminderTime, nextReminderTag, "Time to Drink Water!!");
        ...
        private void ScheduleDrinkReminderWithText(DateTime when, string tag, string text)
        {
            ResourceLoader resources = ResourceLoader.GetForCurrentView();
